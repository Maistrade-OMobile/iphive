...
const HowSection = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: (
        <>
          Innovators: Start a new submission, choose the IP type, and upload
          documents.
          <br />
          Investors: Browse the marketplace and filter for innovations that
          interest you.
        </>
      ),
    },
    {
      ...
      description: (
        <>
          Innovators: Pay securely, then track your IP status from your
          dashboard.
          <br />
          IPTTO Staff: Review and approve submissions.
          <br />
          Investors: View secure, verified innovation profiles.
        </>
      ),
    },
    {
