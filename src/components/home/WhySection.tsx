		...
		<section>
			<Container>
				<>
					...
					/>
					<div className="flex flex-col lg:flex-row justify-center lg:items-center gap-8 gap-y-12 mt-12">
						{values.map((value) => {
							...
							return (
								<div
									...
									key={value.title}
								>
									<div className="rounded-full mx-auto w-20 lg:w-30 h-20 lg:h-30 bg-primary flex items-center justify-center">
										<Icon
