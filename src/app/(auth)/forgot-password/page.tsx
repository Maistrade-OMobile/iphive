...
export default function ForgotPasswordPage() {
  ...
  return (
    ...
    {!linkSent ?
        ...
        <form onSubmit={handleSubmit} className="space-y-12 text-center items-center justify-center">
            <div>
                <label
                htmlFor="email"
        ...
        <AuthContainer>
            <div className='space-y-5 text-center items-center justify-center flex flex-col'>
                ...
                <div className='w-full'>
                    <button
                        type="submit"
                        className="mb-3 bg-primary text-white hover:bg-[#300B22] w-full font-medium py-3 px-4 rounded-md cursor-pointer transition-colors"
                    >
                        Back to Sign in
                    </button>
                    <button
